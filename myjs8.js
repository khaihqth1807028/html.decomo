    ...
    xhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            for (var i = 0; i < jsObject.items.length; i++) {
                ...
                videoItem += ' <iframe width="600" height="315" src="https://www.youtube.com/embed/' + jsObject.items[i].id.videoId + '" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen class="video"></iframe>';
